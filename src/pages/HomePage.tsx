...
const HomePage: React.FC = () => {
  ...
  // Helper: smooth scroll to shift selection
  const scrollToShift = () => {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col gap-3 md:gap-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    1) Выберите сотрудников на смену. 2) При необходимости назначьте роли. 3) Нажмите «Начать смену».
                  </p>
                  <div className="mt-3 flex flex-wrap gap-2">
                    <button
                      onClick={scrollToShift}
                      className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-primary text-white hover:bg-primary/90 transition-colors text-sm"
                    >
        ...
        <div ref={shiftSectionRef} className="card-with-shadow p-3 sm:p-4 ring-0 focus-within:ring-2 focus-within:ring-primary/40">
          <div className="flex flex-wrap justify-between items-center mb-2">
            <h3 className="text-base font-medium flex items-center gap-2">
              {!isShiftLocked || isEditingShift ? (
                <span className="inline-flex items-center gap-1 text-[11px] text-primary bg-primary/10 px-2 py-0.5 rounded-full"><span className="font-semibold">1</span> шаг</span>
              ) : null}
              {isShiftLocked && !isEditingShift
            ...
            <>
              ...
              <div className="mt-1">
                <button
                  ...
                  title={shiftEmployees.length === 0 ? 'Выберите хотя бы одного сотрудника' : undefined}
                >
                  {loading.savingShift ? (
                    <>
                ...
                {shiftEmployees.length === 0 && (
                  <span className="ml-2 text-xs text-muted-foreground inline-flex items-center gap-1">
                    ...
                    Добавьте хотя бы одного работника
                  </span>
                )}
              </div>
            </>
                    ...
                    >
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                          ...
                          >
                            {!shiftStarted && (
                              <span className="absolute -top-1 -right-1 px-1 py-0.5 rounded bg-muted text-[10px] text-muted-foreground border border-border">
                                Начните смену
                              </span>
                            )}
...
// ... rest of the file remains unchanged (AddCarWashModal, AppointmentsWidget, EmployeeDetailModal, DailyReportModal) ...
// (The rest of the code is unchanged from the original file above.)
...
// ... (rest of AddCarWashModal, AppointmentsWidget, EmployeeDetailModal, DailyReportModal as in original file) ...
