    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto space-y-6 animate-in fade-in duration-500">
      ...
      <div className="w-full overflow-x-auto pb-2 -mb-2 scrollbar-hide">
        ...
        <TabsContent value="safe" className="space-y-4 focus-visible:outline-none animate-in fade-in duration-300">
          <SharedSafeSettings safeBalance={state.safeBalance} safeTransactions={state.safeTransactions} onTransactionComplete={(tx, nb) => { dispatch({ type: "ADD_SAFE_TRANSACTION", payload: tx }); dispatch({ type: "SET_SAFE_BALANCE", payload: nb }); }} />
        </TabsContent>
      </Tabs>
    </div>
  );
