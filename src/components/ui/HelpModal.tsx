        ...
        <div>
          ...
          <div className="bg-primary/5 border border-primary/20 p-5 rounded-2xl">
            <ul className="list-disc pl-5 space-y-2 text-xs">
              ...
              <li><strong>История выплат:</strong> Нажмите на сотрудника в разделе «Отчеты», чтобы увидеть его детализацию, аналитику, и кнопку просмотра полной истории выплат за выбранный период.</li>
