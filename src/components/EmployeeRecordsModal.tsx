...
import { calculateHourlyWage } from '@/lib/utils';
            ...
            <div className="grid grid-cols-4 gap-2 mb-4">
              ...
              <div className={`p-2 rounded-md text-center ${
                ...
                <div className={`text-xs ${
                  ...
                  Заработок ({calculateHourlyWage(statistics.totalEarnings).toFixed(1)}/ч)
                </div>
              </div>
              ...
              <div className={`p-2 rounded-md text-center ${
                ...
                <div className={`text-xs ${
                  ...
                  Среднее ({calculateHourlyWage(statistics.totalEarnings / Math.max(statistics.totalRecords, 1)).toFixed(1)}/ч)
                </div>
              </div>
            </div>
